...
const Hero = () => {
    ...
    return (
        <div className='container 2xl:px-20 mx-auto my-10'>
            <div className='bg-gradient-to-r from-indigo-900 via-purple-900 to-teal-950 text-white py-16 text-center mx-2 rounded-xl shadow-lg relative overflow-hidden'>
